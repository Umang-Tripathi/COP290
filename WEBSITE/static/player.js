...
function update_game(){
    ...
    if(time_left_for_new_trash==0 && total_trashes_now<=10){
        ...
        if(type_of_trash==0){
            ...
            // let url_required="trash_toss_images/trash/glass/glass"+choose+".png";
            // kk.src="{{ url_for('static', filename=url_required) }}";
            kk.src="../static/trash_toss_images/trash/metal/metal"+choose+ ".png";
            ...
            m.appendChild(kk);            // let url_required="trash_toss_images/trash/glass/glass"+choose+".png";
            // kk.src="{{ url_for('static', filename=url_required) }
            ...
            let choose=Math.floor(Math.random()*4)+1;
            let kk=document.createElement("img");
            kk.src="../static/trash_toss_images/trash/glass/glass"+choose+ ".png";
            //console.log("./trash/glass/glass"+choose)
           ...
           // kk.src="./images/trash/paper/paper"+choose+".png";
            kk.src="../static/trash_toss_images/trash/paper/paper"+choose+ ".png";
            ...
            let choose=Math.floor(Math.random()*4)+1;
            let kk=document.createElement("img");
            kk.src="../static/trash_toss_images/trash/plastic/plastic"+choose+ ".png";
           // kk.src="./images/trash/plastic/plastic"+choose+".png";
            ...
            let kk=document.createElement("img");
            kk.src="../static/trash_toss_images/trash/organic/org"+choose+ ".png";
            ...
            let kk=document.createElement("img");
            kk.src="../static/trash_toss_images/trash/hazard/hazard"+choose+ ".png";
    ...
    if(time_left_for_new_monsters==0 && total_monsters_now<=20){
        ...
        if(rr==0){
            ...
            //kk.src="{{ url_for('static', filename='trash_toss_images/trash/monsters/yellow_dustbin.png' }}";
            kk.src="../static/trash_toss_images/monsters/yellow_dustbin.png";
            ...
            let kk=document.createElement("img");
            kk.src="../static/trash_toss_images/monsters/white_dustbin.png";
            m.appendChild(kk);
            ...
            let kk=document.createElement("img");
            kk.src="../static/trash_toss_images/monsters/blue_dustbin.png";
            kk.id=new_monsters_id+"img"
            m.appendChild(kk);
            ...
            let kk=document.createElement("img");
            kk.src="../static/trash_toss_images/monsters/green_dustbin.png";
            kk.id=new_monsters_id+"img"
            m.appendChild(kk);
            ...
            let kk=document.createElement("img");
            kk.src="../static/trash_toss_images/monsters/red_dustbin.png";
            kk.id=new_monsters_id+"img"
            m.appendChild(kk);
