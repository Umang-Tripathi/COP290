...
// Load sound effects
// const collisionSound = new Audio('./audio_files/collision_sound.mp3');
// const trashShotSound = new Audio('./audio_files/trash_shot_sound.mp3');
...
// // Function to play collision sound effect
// function playCollisionSound() {
//     collisionSound.play();
// }

// // Function to play trash shot sound effect
// function playTrashShotSound() {
//     trashShotSound.play();
// }
...
window.addEventListener("click", (event) => {
    ...
    for(let i=0;i<trash.length;i++){
        if(trash[i].holded){
            ...
            playtrash_throw_Sound()   // added sound.
        ...
        for(let j=0;j<trash.length;j++){
            if(trash[j].speed!=0 && Math.abs(trash[j].posn_x-monster[i].posn_x)<20 && Math.abs(trash[j].posn_y-monster[i].posn_y)<20){
                if(trash[j].type!=monster[i].type){
                    playheart_reduce_Sound()    // added sound.  
                    hearts-=1;
                }
                else{
